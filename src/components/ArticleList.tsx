...
const articles = [
  ...
  },
  {
    ...
    excerpt: "Explore how yin yoga can improve flexibility and reduce stress.",
    category: "Yoga",
    date: "April 28, 2023",
  ...
  },
  {
    ...
    excerpt: "Try these delicious smoothie recipes to boost your energy naturally.",
    category: "Nutrition",
    date: "April 22, 2023",
    image: "https://picsum.photos/800/500?random=18",
    alt: "Colorful smoothie in glass"
  },
  {
    id: 6,
    title: "Mindful Walking in Nature",
    excerpt: "How to practice mindfulness while walking outdoors.",
    category: "Mindfulness",
    date: "April 15, 2023",
    image: "https://picsum.photos/800/500?random=19",
    alt: "Person walking on forest path"
  }
]
        ...
        <div key={article.id} className="bg-secondary rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
          ...
          <div className="p-6">
            ...
            <h3 className="text-xl font-serif font-bold my-2">
              <Link to={`/articles/${article.id}`} className="hover:text-accent transition">
                {article.title}
              </Link>
            </h3>
